...
Use: 
Arguments:  
Returns:Returns the index within the C string str of the first occurrence of the character ch. If no such character occurs in the string, then -1 is returned.
*********************************************/
int indexOf(const char* str, char ch)
{
